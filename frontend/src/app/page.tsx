...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen w-full bg-[var(--background)] flex flex-col items-center justify-center relative overflow-hidden transition-opacity duration-300 ${isFading ? 'opacity-0' : 'opacity-100'}`}>
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 p-8 rounded-3xl soft-glass-card border border-white/10 dark:border-white/10 shadow-2xl animate-fade-in max-w-xs w-full text-center">
        {/* App Logo Badge */}
        ...
        <div className="space-y-1">
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">DriveFlow</h1>
          <p className="text-xs text-cyan-600 dark:text-cyan-300/80 font-medium">Securing Workspace...</p>
        </div>
