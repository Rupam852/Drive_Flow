    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center text-white">
        ...
        >
          ...
          <div>
            <h4 className="text-base font-bold text-white tracking-tight">Loading Dashboard...</h4>
            <p className="text-xs text-gray-400 mt-1">Fetching storage & files statistics</p>
          </div>
        </motion.div>
      </div>
    );
