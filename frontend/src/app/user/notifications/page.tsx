...
import {
  ...
  X, Copy, CheckCircle2, ChevronRight, Calendar, Megaphone, Link2
} from 'lucide-react';
        ...
        <button
          ...
          className={`px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer border ${
            filter === 'all'
              ...
              : 'bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-white/10 hover:bg-slate-200/70 dark:hover:bg-white/10'
          }`}
        >
            ...
            >
              ...
              <div className="p-5 overflow-y-auto space-y-4 flex-1">
                ...
                {selectedNotification.link && (
                  <div className="p-3.5 rounded-xl bg-slate-100/90 dark:bg-white/5 border border-slate-200 dark:border-white/10 flex items-center justify-between gap-3 shadow-xs">
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="w-9 h-9 rounded-lg bg-purple-100 dark:bg-purple-500/20 text-purple-700 dark:text-purple-300 flex items-center justify-center shrink-0 border border-purple-200/70 dark:border-purple-500/30">
                        <Link2 className="w-4 h-4 text-purple-700 dark:text-purple-300" />
                      </div>
                    ...
                    <a
                      ...
                      className="px-3.5 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 active:scale-95 transition-all text-white font-bold text-xs flex items-center gap-1.5 shrink-0 shadow-sm"
                      style={{ color: '#ffffff', backgroundColor: '#7c3aed' }}
                    >
                      <span style={{ color: '#ffffff', fontWeight: 700 }}>Open Link</span>
              ...
              <div className="p-4 border-t border-slate-200 dark:border-white/10 bg-slate-50/50 dark:bg-white/[0.02] flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="button"
                    onClick={() => setSelectedNotification(null)}
                    className="px-4 py-1.5 rounded-xl bg-purple-600 hover:bg-purple-700 !text-white text-xs font-semibold transition-colors cursor-pointer shadow-sm shadow-purple-500/20"
                  >
                    Close
                  </button>
                </div>
